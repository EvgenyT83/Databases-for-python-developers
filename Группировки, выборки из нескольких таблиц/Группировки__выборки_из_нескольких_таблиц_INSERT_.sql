...
INSERT INTO Album(name, year)
	...
	('Rolling in the Deep', 2019),
	('Звезда по имени Солнце', 1989),
	('ResuRection', 2002),
	('Ни кому ни кабельность', 1994),
	('Из сериала «Эйфория»', 2020),
	('Won-t Forget You', 2020),
	('Years & Years', 2020),
	('Bones', 2019),
	('The Motto', 2020),
	('Группа крови', 1988),
...
INSERT INTO Сollection(name, year)
	VALUES('Вечные хиты', 2019),
	('Хиты FM', 2020),
	('Громкие новинки месяца', 2020),
	('Популярно в Екатеринбурге', 2020),
	('Лучшие песни русского рока', 2019),
	('100 танцевальных хитов', 2020),
	('100 суперхитов', 2022),
	('Эрон-дон-дон', 2019);
